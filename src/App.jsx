        ...
        <section className="container mx-auto px-6 py-20">
            <div className="max-w-4xl mx-auto bg-gray-800/40 backdrop-blur-sm p-8 md:p-12 rounded-3xl border border-white/5">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
                    ...
                    <a href={cvFile} download="Valentino_Cumbo_CV.pdf" className="mt-6 md:mt-0 bg-white/5 hover:bg-white/10 text-white font-bold py-3 px-8 rounded-2xl border border-white/10 transition-all flex items-center gap-3 cursor-pointer">
